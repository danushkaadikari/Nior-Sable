/*
 ...
 50% back to community on every pool transaction
*/
...
contract Nior is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        excludeFromReward(_holdPoolAddress);
    ...
    function _transfer(
        ...
        // Burn tokens
        if(takeFee) {
            // Stop Burn - 1billion Tokens Circulating Supply
    ...
    function _getTValues(uint256 tAmount) private view returns(uint256, uint256, uint256, uint256) {
        ...
        uint256 tHoldFee = calculateHoldFee(tAmount);
